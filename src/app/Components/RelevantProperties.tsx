...
const RelevantProperties: React.FC<RelevantPropertiesProps> = (
  {
    //   searchTerm,
  ...
  return (
    <div className="bg-neutral-950 w-full  mt-[0.5rem] lg:mt-[2rem]">
      <div className="mt-0 md:mt-0 w-full md:pl-12 p-[1.5rem] flex flex-col justify-start items-start">
        ...
        <div className="w-full h-full flex justify-between items-center mb-[2rem]">
          ...
          {/* {showViewMoreButton && (
            <Link
              href="/Properties"
              className="w-[19rem] md:block bg-neutral-950 flex justify-center items-center text-white py-3 px-4 rounded-lg shadow-xl border-neutral-600 mr-4"
            >
