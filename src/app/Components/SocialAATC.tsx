...
const SocialAATC: React.FC = () => {
  return (
    <div className="w-full h-full flex flex-col md:flex-row-reverse justify-start md:pb-[2.5rem] lg:px-[4rem] md:justify-between items-center bg-white py-[1.25rem]">
